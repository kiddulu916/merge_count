...
void main() {
  test('same date yields identical initial board and drop tiers', () {
    final a = const DailySeeder('2026-06-06').generate();
    final b = const DailySeeder('2026-06-06').generate();
  ...
  test('landingPrng is independent of dropTier draws and reproducible', () {
    const s = DailySeeder('2026-06-06');
